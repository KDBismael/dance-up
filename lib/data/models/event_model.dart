...
final List<EventModel> sampleEvents = [
  EventModel(
    ...
    danceLevel: DanceLevel.intermediate,
    price: Price.paid,
    priceAmount: "15",
  ...
  EventModel(
    ...
    imageUrl: "https://example.com/kizomba.jpg",
    organizerId: "org3",
    tags: [EventTag.chill],
    danceStyle: DanceStyle.kizomba,
    danceLevel: DanceLevel.professional,
    price: Price.paid,
    priceAmount: "10",
    dancePosition: DancePosition.indoor,
    attendeesIds: null,
  ...
  EventModel(
    ...
    imageUrl: "https://example.com/bachata.jpg",
    organizerId: "org5",
  ...
  EventModel(
    ...
    imageUrl: "https://example.com/hiphop.jpg",
    organizerId: "org6",
